...
<body>
    ...
    <div>
    <h1>
    Fill Following Fields to create a unit</h1>
        <p>
            Unit code&nbsp;&nbsp;&nbsp;
    ...
    &nbsp;Unit type&nbsp;
        ...
        <p>
            If a primary key error generated by server press back button and start over</p>
        <p>
            <asp:Button ID="Button1" runat="server" Text="Add" />
        &nbsp;
            <asp:Button ID="Button9" runat="server" Text="Return to Home" />
        </p>
